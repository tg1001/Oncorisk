...
const tcgaPatientIds = [
  "TCGA-E2-A56Z","TCGA-BH-A0EB","TCGA-E2-A1IE","TCGA-BH-A42U","TCGA-LL-A442",
  "TCGA-AR-A24Z","TCGA-E9-A243","TCGA-AO-A12F","TCGA-A1-A0SH","TCGA-E2-A15O",
  "TCGA-C8-A274","TCGA-BH-A0DV","TCGA-PE-A5DD","TCGA-AR-A5QM","TCGA-A2-A3XZ",
  "TCGA-AR-A1AY","TCGA-BH-A0BZ","TCGA-C8-A1HG","TCGA-E2-A2P6","TCGA-A8-A07O",
  "TCGA-BH-A0DT","TCGA-E9-A1N4","TCGA-C8-A8HQ","TCGA-E2-A15D","TCGA-LD-A7W6",
  "TCGA-EW-A1PB","TCGA-LL-A5YL","TCGA-BH-A0HI","TCGA-AR-A255","TCGA-BH-A0DX",
  
  "TCGA-E9-A244","TCGA-A7-A3IZ","TCGA-AR-A2LN"
];

const tcgaPatients = tcgaPatientIds.map(id => ({
  value: id,
  label: id
}));
  const handleAnalyze = () => {
